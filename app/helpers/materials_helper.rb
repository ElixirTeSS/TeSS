module MaterialsHelper
  ...
  ELEARNING_MATERIALS_INFO = "Elearning materials are curated materials focused on elearning.\n\n"\
  "If your website contains elearning materials that you wish to include in TeSS, please contact the TeSS team (<a href='#{TeSS::Config.contact_email}'>#{TeSS::Config.contact_email}</a>) for further details.".freeze
