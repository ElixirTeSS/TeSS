...
class RakeTasksMaterialIngestion < ActiveSupport::TestCase
  ...
  test 'check ingestion and validation of materials from zenodo' do
    ...
    message = 'Sources processed = 4'
    assert logfile_contains(logfile, message), 'Message not found: ' + message
    message = 'IngestorMaterialRest: materials extracted = 17'
    assert logfile_contains(logfile, message), 'Message not found: ' + message
    message = 'IngestorMaterialRest: materials extracted = 10'
    assert logfile_contains(logfile, message), 'Message not found: ' + message
    message = 'IngestorMaterialRest: materials extracted = 3'
    assert logfile_contains(logfile, message), 'Message not found: ' + message
    message = 'IngestorMaterialRest: materials added\[17\] updated\[0\] rejected\[0\]'
    assert logfile_contains(logfile, message), 'Message not found: ' + message
    message = 'IngestorMaterialRest: materials added\[10\] updated\[0\] rejected\[0\]'
    assert logfile_contains(logfile, message), 'Message not found: ' + message
    message = 'IngestorMaterialRest: materials added\[1\] updated\[1\] rejected\[1\]'
    assert logfile_contains(logfile, message), 'Message not found: ' + message
