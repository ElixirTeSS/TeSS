  ...
  test 'merge users' do
    user1 = User.create!(username: 'base_user', password: '12345678', email: 'base-user@example.com',
                         processing_consent: '1', profile_attributes: {
                           expertise_technical: %w[Python Ruby R],
    ...
    user2 = User.create!(username: 'merge_user', password: 'xyz123456', email: 'merge-user@example.com',
                         processing_consent: '1', profile_attributes: {
                           ...
                           expertise_technical: %w[Java Python R],
    ...
    user2.events.create!(title: 'event 1', url: 'https://training.com/events/1')
    ...
    assert_equal %w[Python Ruby R Java], profile.expertise_technical
