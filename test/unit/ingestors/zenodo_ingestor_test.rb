...
class ZenodoIngestorTest < ActiveSupport::TestCase
  ...
  test 'can ingest materials from zenodo' do
    ...
    material = get_zenodo_id(10_656_276, 'Australian national Persistent Identifier (PID) strategy 2024', 'Portal Provider')
    ...
    material = get_zenodo_id(10_525_947, 'HASS and Indigenous Research Data Commons co-design framework', 'Portal Provider')
    assert !material.description.nil?, 'material description is nil!'
    ...
    material = get_zenodo_id(10_052_012, 'Privacy focused health data storage and access control through personal online datastores', 'Portal Provider')
  ...
  def get_zenodo_id(id, title, provider)
    ...
    materials = Material.where(title:, url:)
