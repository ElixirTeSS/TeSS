...
class MaterialCsvIngestorTest < ActiveSupport::TestCase
  ...
  test 'can ingest materials from CSV file' do
    ...
    assert_includes material.keywords, 'first', 'material keyword[first] missing.'
    ...
    # authors
    refute_nil material.authors, 'material authors is nil'
    assert_equal 0, material.authors.size, 'material authors count not matched.'
    # contributors
    refute_nil material.contributors, 'material contributors is nil'
    assert_equal 1, material.contributors.size, 'material contributors count not matched.'
    assert_includes material.contributors, 'Sam Smiths', 'material contributor[Sam Smiths] missing.'
    refute_includes material.contributors, 'Wily Coyote', 'material contributor[Wily Coyote] exists.'
    # fields
    refute_nil material.fields, 'material fields is nil'
    ...
    # audiences
    refute_nil material.target_audience, 'material target audience is nil'
    ...
    refute_nil material.doi, "#{title}: doi is nil."
  ...
  test 'check ingestion and updating of material from csv file' do
    ...
    assert_nil get_material(title, url)
    ...
    refute_nil updated.last_scraped, 'Updated last scraped is nil!'
    ...
    assert_includes updated.keywords, 'book', 'Updated keywords missing value!'
    assert_equal 2, updated.authors.size, "Updated authors count not matched! ... #{updated.authors.inspect}"
    assert_includes updated.authors, 'Steven Smith', 'Updated authors[Steven Smith] missing!'
    assert_includes updated.authors, 'Sam Harpic', 'Updated authors[Sam Harpic] missing!'
