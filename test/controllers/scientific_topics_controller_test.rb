...
class ScientificTopicsControllerTest < ActionController::TestCase
  ...
  setup do
    @scientific_topic = scientific_topics(:topic_one)
  end
  ...
  test "should not update scientific_topic" do
    sign_in users(:regular_user)
  ...
  test "should not destroy scientific_topic" do
    sign_in users(:regular_user)
    assert_no_difference('ScientificTopic.count') do
